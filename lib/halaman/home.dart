...
class Home extends StatelessWidget {
  ...
  void _showTimerSettingsDialog(BuildContext context) {
    ...
    final TextEditingController focusController = TextEditingController(
      text: (timerService.focusSeconds ~/ 60).toString(),
    );
    final TextEditingController breakController = TextEditingController(
      text: (timerService.breakSeconds ~/ 60).toString(),
    );
    final TextEditingController longBreakController = TextEditingController(
      text: (timerService.longBreakSeconds ~/ 60).toString(),
    );
    final TextEditingController babakController = TextEditingController(
      text: timerService.babak.toString(),
    );
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    final numVal = int.tryParse(value);
                    if (numVal == null) return "Harus berupa angka";
                    if (numVal < 15 || numVal > 30) {
                      return "Durasi 15 hingga 30 menit.";
                    }
                    return null;
                  },
                ),
