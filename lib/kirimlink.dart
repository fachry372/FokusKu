...
class _KirimlinkState extends State<Kirimlink> {
  ...
  void kirim () async {
    ...
    try {
      ...
      ScaffoldMessenger
      .of(context).clearSnackBars();
       ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Link reset password berhasil dikirim! Cek email Anda.")));
          ...
          child: Column(
            ...
            const SizedBox(height: 37,),
              ...
              Center(
                ...
                onPressed: (isenabled && !isLoading && remainingSeconds == 0) ? () {if (_formKey.currentState!.validate()
                ) {
                  kirim();
                }} : null,
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor: (isenabled && remainingSeconds == 0 ) ? Color(0xFF52B755) : Color(0xFFA2B9A3),
                ...
                child: CircularProgressIndicator(
                  ...
                  strokeWidth: 3,
                    ...
                    : Text(
                    remainingSeconds > 0 ? "Kirim (${remainingSeconds}s)"  :
                "Kirim",
            ...
            Padding(padding: EdgeInsetsGeometry.only(left: 41 ,right: 20),
            child: Text("Jika pesan tidak muncul, coba periksa folder Spam.",
            style: GoogleFonts.inter(fontSize: 14,color: Color(0xff606C60)),),
            ),
